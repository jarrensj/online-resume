            ...
            <div className="card p-8 mb-8">
              ...
              <div className="text-left space-y-4 mb-8">
                ...
                <div className="space-y-3">
                  <span className="font-medium block" style={{ color: 'var(--foreground)' }}>Your Profile Link:</span>
                  <div className="flex items-center gap-2 p-3 rounded-xl" style={{ background: 'var(--background)', border: '1.5px solid var(--border-gentle)' }}>
                    <a 
                      href={`/${userProfile.username}`}
                      className="flex-1 underline decoration-2 underline-offset-4 transition-colors truncate"
                    ...
                    <button
                      ...
                      className="px-4 py-2 font-medium rounded-lg transition-all duration-200 flex items-center gap-2 whitespace-nowrap"
                      style={{ 
